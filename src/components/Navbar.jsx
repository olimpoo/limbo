...
const Navigation = () => (
  <Navbar expand="md" className="Navbar" fixed="top">
    <Navbar.Brand href="#" className="Navbar__brand">Limbo</Navbar.Brand>
      ...
      <NavDropdown title="Comprar" className="Navbar__dropdown">
        <Row className="Navbar__dropdown-container">
          <Col>
            ...
            { cities.map((city) => <Nav.Link className="Navbar__dropdown-item">{ city }</Nav.Link>) }
          </Col>
          <Col>
            <Navbar.Text>Tipo de propiedad</Navbar.Text>
            { types.map((type) => <Nav.Link className="Navbar__dropdown-item">{ type }</Nav.Link>) }
          </Col>
          <Col>
            <Navbar.Text>Habitaciones</Navbar.Text>
            { rooms.map((room) => <Nav.Link className="Navbar__dropdown-item">{ room }</Nav.Link>) }
          </Col>
        </Row>
      </NavDropdown>
